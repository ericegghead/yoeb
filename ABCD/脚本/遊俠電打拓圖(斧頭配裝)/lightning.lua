...
SetNeedSkillLineData(96,"先祖戰吼,nil|恢復輔助,nil|持續時間延長輔助,nil|凋零之步,nil",nil,10,nil)
SetNeedSkillLineData(97,"刺客印記,nil|擊中時印記輔助,nil|鮮血狂怒,nil|持續時間縮短輔助,nil",nil,9,nil)
SetNeedSkillLineData(98,"受傷時施放輔助,nil|熔岩護盾,nil|屍術傳送,nil|召喚寒冰魔像,nil",nil,5,nil)
SetNeedSkillLineData(99,"啟蒙,nil|優雅,nil|精準,nil|雷霆,nil|冰霜之捷,nil|純淨之捷,nil",nil,2,nil)
SetNeedSkillLineData(100,"瓦爾．閃電打擊,nil|多重打擊輔助,nil|附加閃電傷害輔助,nil|元素攻擊傷害輔助,nil|三體輔助,nil|增加暴擊率輔助,nil",nil,3,nil)
