...
SetUseZhuangBeiTypeData("Int","手套")
...
SetNeedSkillLineData(84,"堅定,nil|血肉奉獻,nil|號召,nil",nil,3,nil)--主武器 
SetNeedSkillLineData(85,"烈焰衝刺,nil|導電,nil|褻瀆,nil|反抗之旗,nil",nil,9,nil)
SetNeedSkillLineData(86,"受傷時施放輔助,nil|鋼筋鐵骨,nil|屍術傳送,nil",nil,4,nil)--副武器
SetNeedSkillLineData(87,"喚醒幽魂,nil|多重打擊輔助,nil|近戰傷害擴散輔助,nil|召喚物傷害輔助,nil",nil,10,nil)
SetNeedSkillLineData(88,"殭屍復甦,nil|豢養狂熱輔助,nil|召喚巨石魔像,nil|召喚幻影輔助,nil",nil,5,nil)
SetNeedSkillLineData(90,"赦免,nil|施放迴響輔助,nil|物理轉閃電輔助,nil|召喚物傷害輔助,nil|閃電穿透輔助,nil|增加暴擊傷害輔助,nil",nil,2,nil)
...
SetZhengTiColorVarData(9,0,1,3,nil,300,true)--red green blue
SetZhengTiColorVarData(9,0,2,2,nil,250,true)
SetZhengTiColorVarData(9,0,1,2,nil,200,true)
...
SetZhengTiColorVarData(10,2,0,1,nil,300,true)
