...
SetNeedSkillLineData(100,"閃電打擊,nil|夜刃輔助,nil|附加冰冷傷害輔助,nil|霜咬輔助,nil|附加閃電傷害輔助,nil|啟發輔助,nil|快速攻擊輔助,nil",nil,nil,nil)

--添加攻击技能 name=技能名 className=技能类名 noLine=不在直线就能攻击 挑选攻击技能会从上到下寻找，要把厉害的技能加在前面

AddAttackSkillData("閃電打擊","Spectral Helix")
...
--游侠--孔色
SetZhengTiColorVarData(2,1,4,1,nil,700,true)
SetZhengTiColorVarData(2,1,5,0,nil,660,true)
SetZhengTiColorVarData(2,0,5,1,nil,630,true)
