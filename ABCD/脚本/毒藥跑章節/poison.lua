...
SetNeedSkillLineData(95,"元素淨化,nil|戰爭之旗,nil",nil,9,nil)
SetNeedSkillLineData(96,"鋼筋鐵骨,nil|先祖衛士,nil|凋零之觸輔助,nil",nil,4,nil)
SetNeedSkillLineData(97,"凋零之步,nil|病疫之難,nil",nil,nil,nil)
SetNeedSkillLineData(98,"苦痛之捷,nil|快速攻擊輔助,nil|召喚閃電魔像,nil",nil,nil,nil)
SetNeedSkillLineData(99,"爆裂陷阱,nil|迅速組裝輔助,nil|機率中毒輔助,nil",18,nil,nil)
SetNeedSkillLineData(100,"毒藥,nil|高階多重投射輔助,nil|高階齊射輔助,nil|猛毒投射物輔助,nil|低階多重投射輔助,nil|齊射輔助,nil|虛空操縱輔助,nil",nil,nil,nil)

--添加攻击技能 name=技能名 className=技能类名 noLine=不在直线就能攻击 挑选攻击技能会从上到下寻找，要把厉害的技能加在前面

AddAttackSkillData("毒藥","Spectral Helix")
...
SetZhengTiColorVarData(3,0,1,1,nil,20,true)
